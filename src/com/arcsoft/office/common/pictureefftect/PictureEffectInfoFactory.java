 ...
 * 时间:              上午9:08:14
 */
package com.arcsoft.office.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.arcsoft.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
