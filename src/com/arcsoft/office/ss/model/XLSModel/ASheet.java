 ...
 * 时间:              下午1:55:20
 */
package com.arcsoft.office.ss.model.XLSModel;
...
import com.arcsoft.office.common.shape.AChart;
...
import com.arcsoft.office.constant.SSConstant;
import com.arcsoft.office.fc.hssf.model.InternalSheet;
import com.arcsoft.office.fc.hssf.model.InternalWorkbook;
import com.arcsoft.office.fc.hssf.record.BlankRecord;
import com.arcsoft.office.fc.hssf.record.CellValueRecordInterface;
import com.arcsoft.office.fc.hssf.record.DefaultRowHeightRecord;
import com.arcsoft.office.fc.hssf.record.EscherAggregate;
import com.arcsoft.office.fc.hssf.record.HyperlinkRecord;
import com.arcsoft.office.fc.hssf.record.RecordBase;
import com.arcsoft.office.fc.hssf.record.RowRecord;
import com.arcsoft.office.fc.hssf.usermodel.HSSFAutoShape;
import com.arcsoft.office.fc.hssf.usermodel.HSSFChart;
import com.arcsoft.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.arcsoft.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.arcsoft.office.fc.hssf.usermodel.HSSFFreeform;
import com.arcsoft.office.fc.hssf.usermodel.HSSFLine;
import com.arcsoft.office.fc.hssf.usermodel.HSSFPatriarch;
import com.arcsoft.office.fc.hssf.usermodel.HSSFPicture;
import com.arcsoft.office.fc.hssf.usermodel.HSSFPictureData;
import com.arcsoft.office.fc.hssf.usermodel.HSSFRichTextString;
import com.arcsoft.office.fc.hssf.usermodel.HSSFShape;
import com.arcsoft.office.fc.hssf.usermodel.HSSFShapeGroup;
import com.arcsoft.office.fc.hssf.usermodel.HSSFSheet;
import com.arcsoft.office.fc.hssf.usermodel.HSSFTextbox;
import com.arcsoft.office.fc.hssf.usermodel.HSSFWorkbook;
import com.arcsoft.office.fc.hssf.util.HSSFPaneInformation;
import com.arcsoft.office.fc.ss.util.HSSFCellRangeAddress;
import com.arcsoft.office.fc.xls.ChartConverter;
import com.arcsoft.office.java.awt.Rectangle;
import com.arcsoft.office.ss.model.CellRangeAddress;
import com.arcsoft.office.ss.model.baseModel.Cell;
import com.arcsoft.office.ss.model.baseModel.Row;
import com.arcsoft.office.ss.model.baseModel.Sheet;
import com.arcsoft.office.ss.model.baseModel.Workbook;
import com.arcsoft.office.ss.model.drawing.AnchorPoint;
import com.arcsoft.office.ss.model.drawing.CellAnchor;
import com.arcsoft.office.ss.model.sheetProperty.PaneInformation;
import com.arcsoft.office.ss.util.ModelUtil;
import com.arcsoft.office.ss.util.SectionElementFactory;
import com.arcsoft.office.system.AbortReaderError;
import com.arcsoft.office.system.AbstractReader;
import com.arcsoft.office.system.IControl;
import com.arcsoft.office.thirdpart.achartengine.chart.AbstractChart;
import com.arcsoft.office.thirdpart.achartengine.chart.RoundChart;
import com.arcsoft.office.thirdpart.achartengine.chart.XYChart;
import com.arcsoft.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.arcsoft.office.fc.ss.usermodel.Sheet
{
     ...
     * @see com.arcsoft.office.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.arcsoft.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.arcsoft.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.arcsoft.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.arcsoft.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.arcsoft.office.ss.model.sheetProperty.ColumnInfo(
