...
//		public int getAlpha();
//
//		public void stateChanged(int color, int width, int alpha);
//	}
	...
	public ColorPickerDialog(Context context,
		...
		// mListener = new OnStateChangedListener() {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// public void colorChanged(int color) {
		// mChangedListener.colorChanged(color);
		// dismiss();
		// }
		// };
		...
		View view = LayoutInflater.from(mContext).inflate(
				R.layout.pen_setting_dialog, null);

		final ColorPickerView colorView = (ColorPickerView) view
		...
		// final CheckBox calloutBox = (CheckBox)
		// view.findViewById(R.id.callout);
		// final CheckBox eraseBox = (CheckBox) view.findViewById(R.id.erase);
