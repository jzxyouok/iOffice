...
import com.arcsoft.office.fc.POIDocument;
import com.arcsoft.office.fc.codec.DigestUtils;
...
import com.arcsoft.office.fc.hssf.OldExcelFormatException;
import com.arcsoft.office.fc.hssf.formula.FormulaShifter;
import com.arcsoft.office.fc.hssf.formula.FormulaType;
import com.arcsoft.office.fc.hssf.formula.SheetNameFormatter;
...
import com.arcsoft.office.fc.hssf.model.DrawingManager2;
import com.arcsoft.office.fc.hssf.model.HSSFFormulaParser;
import com.arcsoft.office.fc.hssf.model.InternalSheet;
import com.arcsoft.office.fc.hssf.model.InternalWorkbook;
import com.arcsoft.office.fc.hssf.model.RecordStream;
...
import com.arcsoft.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import com.arcsoft.office.fc.hssf.record.RecordFactory;
import com.arcsoft.office.fc.hssf.record.SSTRecord;
import com.arcsoft.office.fc.hssf.record.SubRecord;
...
import com.arcsoft.office.fc.hssf.record.common.UnicodeString;
import com.arcsoft.office.fc.hssf.util.CellReference;
import com.arcsoft.office.fc.poifs.filesystem.DirectoryNode;
import com.arcsoft.office.fc.poifs.filesystem.POIFSFileSystem;
import com.arcsoft.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.arcsoft.office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements com.arcsoft.office.fc.ss.usermodel.Workbook
{
     ...
     *        in memory
     * @see com.arcsoft.office.fc.poifs.filesystem.POIFSFileSystem
...
//            names.add(name);
    ...
    /**
      ...
      * @see com.arcsoft.office.fc.hssf.record.LabelRecord
      * @see com.arcsoft.office.fc.hssf.record.LabelSSTRecord
      * @see com.arcsoft.office.fc.hssf.record.SSTRecord
      */
     ...
     * @see com.arcsoft.office.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link com.arcsoft.office.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(com.arcsoft.office.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see com.arcsoft.office.fc.hssf.record.FormatRecord
