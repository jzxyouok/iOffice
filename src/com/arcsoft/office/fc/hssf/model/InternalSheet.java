...
package com.arcsoft.office.fc.hssf.model;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

import com.arcsoft.office.fc.hssf.formula.FormulaShifter;
import com.arcsoft.office.fc.hssf.record.BOFRecord;
import com.arcsoft.office.fc.hssf.record.CFHeaderRecord;
import com.arcsoft.office.fc.hssf.record.CalcCountRecord;
import com.arcsoft.office.fc.hssf.record.CalcModeRecord;
import com.arcsoft.office.fc.hssf.record.CellValueRecordInterface;
import com.arcsoft.office.fc.hssf.record.ColumnInfoRecord;
import com.arcsoft.office.fc.hssf.record.ContinueRecord;
import com.arcsoft.office.fc.hssf.record.DVALRecord;
import com.arcsoft.office.fc.hssf.record.DefaultColWidthRecord;
import com.arcsoft.office.fc.hssf.record.DefaultRowHeightRecord;
import com.arcsoft.office.fc.hssf.record.DeltaRecord;
import com.arcsoft.office.fc.hssf.record.DimensionsRecord;
import com.arcsoft.office.fc.hssf.record.DrawingRecord;
import com.arcsoft.office.fc.hssf.record.EOFRecord;
import com.arcsoft.office.fc.hssf.record.EscherAggregate;
import com.arcsoft.office.fc.hssf.record.FeatHdrRecord;
import com.arcsoft.office.fc.hssf.record.FeatRecord;
import com.arcsoft.office.fc.hssf.record.GridsetRecord;
import com.arcsoft.office.fc.hssf.record.GutsRecord;
import com.arcsoft.office.fc.hssf.record.IndexRecord;
import com.arcsoft.office.fc.hssf.record.IterationRecord;
...
import com.arcsoft.office.fc.hssf.record.PaneRecord;
import com.arcsoft.office.fc.hssf.record.PrintGridlinesRecord;
import com.arcsoft.office.fc.hssf.record.PrintHeadersRecord;
import com.arcsoft.office.fc.hssf.record.Record;
import com.arcsoft.office.fc.hssf.record.RecordBase;
import com.arcsoft.office.fc.hssf.record.RefModeRecord;
import com.arcsoft.office.fc.hssf.record.RowRecord;
import com.arcsoft.office.fc.hssf.record.SCLRecord;
import com.arcsoft.office.fc.hssf.record.SaveRecalcRecord;
import com.arcsoft.office.fc.hssf.record.SelectionRecord;
import com.arcsoft.office.fc.hssf.record.TextObjectRecord;
import com.arcsoft.office.fc.hssf.record.UncalcedRecord;
import com.arcsoft.office.fc.hssf.record.WSBoolRecord;
import com.arcsoft.office.fc.hssf.record.WindowTwoRecord;
import com.arcsoft.office.fc.hssf.record.aggregates.ChartSubstreamRecordAggregate;
import com.arcsoft.office.fc.hssf.record.aggregates.ColumnInfoRecordsAggregate;
import com.arcsoft.office.fc.hssf.record.aggregates.ConditionalFormattingTable;
import com.arcsoft.office.fc.hssf.record.aggregates.CustomViewSettingsRecordAggregate;
import com.arcsoft.office.fc.hssf.record.aggregates.DataValidityTable;
import com.arcsoft.office.fc.hssf.record.aggregates.MergedCellsTable;
import com.arcsoft.office.fc.hssf.record.aggregates.PageSettingsBlock;
import com.arcsoft.office.fc.hssf.record.aggregates.RecordAggregate;
import com.arcsoft.office.fc.hssf.record.aggregates.RecordAggregate.PositionTrackingVisitor;
import com.arcsoft.office.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
import com.arcsoft.office.fc.hssf.record.aggregates.RowRecordsAggregate;
import com.arcsoft.office.fc.hssf.record.aggregates.WorksheetProtectionBlock;
import com.arcsoft.office.fc.hssf.record.chart.ChartRecord;
import com.arcsoft.office.fc.hssf.usermodel.HSSFChart;
import com.arcsoft.office.fc.hssf.util.ColumnInfo;
import com.arcsoft.office.fc.hssf.util.HSSFPaneInformation;
import com.arcsoft.office.fc.ss.util.HSSFCellRangeAddress;
import com.arcsoft.office.fc.util.Internal;
import com.arcsoft.office.fc.util.POILogFactory;
import com.arcsoft.office.fc.util.POILogger;
 ...
 *
 * @see com.arcsoft.office.fc.hssf.model.InternalWorkbook
 * @see com.arcsoft.office.fc.hssf.usermodel.HSSFSheet
 */
@ Internal
public final class InternalSheet
{
     ...
     *
     * @see com.arcsoft.office.fc.hssf.model.InternalWorkbook
     * @see com.arcsoft.office.fc.hssf.record.Record
     */
     ...
     *
     * @see com.arcsoft.office.fc.hssf.record.DimensionsRecord
     */
     ...
     * @see com.arcsoft.office.fc.hssf.record.CellValueRecordInterface
     */
     ...
     * @see com.arcsoft.office.fc.hssf.record.DefaultColWidthRecord
     * @see com.arcsoft.office.fc.hssf.record.ColumnInfoRecord
    ...
    */
     ...
     *
     * @see com.arcsoft.office.fc.hssf.record.SelectionRecord
