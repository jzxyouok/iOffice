 ...
 * 时间:               下午4:23:51
 */
package com.arcsoft.office.fc.ppt;
...
import com.arcsoft.office.common.PaintKit;
import com.arcsoft.office.common.autoshape.ExtendPath;
import com.arcsoft.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.arcsoft.office.common.bg.BackgroundAndFill;
import com.arcsoft.office.common.bg.Gradient;
import com.arcsoft.office.common.bg.LinearGradientShader;
import com.arcsoft.office.common.bg.RadialGradientShader;
import com.arcsoft.office.common.bg.TileShader;
import com.arcsoft.office.common.hyperlink.Hyperlink;
import com.arcsoft.office.common.pictureefftect.PictureEffectInfoFactory;
import com.arcsoft.office.common.shape.AbstractShape;
import com.arcsoft.office.common.shape.ArbitraryPolygonShape;
import com.arcsoft.office.common.shape.Arrow;
import com.arcsoft.office.common.shape.AutoShape;
import com.arcsoft.office.common.shape.GroupShape;
import com.arcsoft.office.common.shape.IShape;
import com.arcsoft.office.common.shape.LineShape;
import com.arcsoft.office.common.shape.PictureShape;
import com.arcsoft.office.common.shape.ShapeTypes;
import com.arcsoft.office.common.shape.TableCell;
import com.arcsoft.office.common.shape.TableShape;
import com.arcsoft.office.common.shape.TextBox;
import com.arcsoft.office.constant.AutoShapeConstant;
import com.arcsoft.office.constant.EventConstant;
import com.arcsoft.office.constant.MainConstant;
import com.arcsoft.office.constant.wp.WPAttrConstant;
import com.arcsoft.office.constant.wp.WPModelConstant;
import com.arcsoft.office.fc.FCKit;
import com.arcsoft.office.fc.ShapeKit;
import com.arcsoft.office.fc.hslf.HSLFSlideShow;
import com.arcsoft.office.fc.hslf.model.Fill;
import com.arcsoft.office.fc.hslf.model.HeadersFooters;
import com.arcsoft.office.fc.hslf.model.Line;
import com.arcsoft.office.fc.hslf.model.MasterSheet;
import com.arcsoft.office.fc.hslf.model.Notes;
import com.arcsoft.office.fc.hslf.model.Shape;
import com.arcsoft.office.fc.hslf.model.ShapeGroup;
import com.arcsoft.office.fc.hslf.model.Sheet;
import com.arcsoft.office.fc.hslf.model.SimpleShape;
import com.arcsoft.office.fc.hslf.model.Slide;
import com.arcsoft.office.fc.hslf.model.SlideMaster;
import com.arcsoft.office.fc.hslf.model.TextShape;
import com.arcsoft.office.fc.hslf.model.TitleMaster;
import com.arcsoft.office.fc.hslf.record.BinaryTagDataBlob;
import com.arcsoft.office.fc.hslf.record.ClientVisualElementContainer;
import com.arcsoft.office.fc.hslf.record.DocumentAtom;
import com.arcsoft.office.fc.hslf.record.OEPlaceholderAtom;
import com.arcsoft.office.fc.hslf.record.PositionDependentRecordContainer;
import com.arcsoft.office.fc.hslf.record.Record;
import com.arcsoft.office.fc.hslf.record.SlideAtom;
import com.arcsoft.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.arcsoft.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.arcsoft.office.fc.hslf.record.SlideProgTagsContainer;
import com.arcsoft.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.arcsoft.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.arcsoft.office.fc.hslf.record.TimeNodeContainer;
import com.arcsoft.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.arcsoft.office.fc.hslf.record.TimeVariant;
import com.arcsoft.office.fc.hslf.record.VisualShapeAtom;
import com.arcsoft.office.fc.hslf.usermodel.PictureData;
import com.arcsoft.office.fc.hslf.usermodel.RichTextRun;
import com.arcsoft.office.fc.hslf.usermodel.SlideShow;
import com.arcsoft.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.arcsoft.office.fc.ss.usermodel.Textbox;
...
import com.arcsoft.office.pg.model.PGModel;
import com.arcsoft.office.pg.model.PGNotes;
import com.arcsoft.office.pg.model.PGSlide;
import com.arcsoft.office.simpletext.font.FontTypefaceManage;
import com.arcsoft.office.simpletext.model.AttrManage;
import com.arcsoft.office.simpletext.model.IAttributeSet;
import com.arcsoft.office.simpletext.model.LeafElement;
import com.arcsoft.office.simpletext.model.ParagraphElement;
import com.arcsoft.office.simpletext.model.SectionElement;
import com.arcsoft.office.ss.util.format.NumericFormatter;
import com.arcsoft.office.system.AbstractReader;
import com.arcsoft.office.system.BackReaderThread;
...
{   
    ...
    private com.arcsoft.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.arcsoft.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.arcsoft.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.arcsoft.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.arcsoft.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.arcsoft.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.arcsoft.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.arcsoft.office.fc.hslf.model.AutoShape  // 文本框 
                    || shape instanceof com.arcsoft.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.arcsoft.office.fc.hslf.model.Freeform
            || shape instanceof com.arcsoft.office.fc.hslf.model.AutoShape
            || shape instanceof com.arcsoft.office.fc.hslf.model.TextBox
            || shape instanceof com.arcsoft.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.arcsoft.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.arcsoft.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.arcsoft.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.arcsoft.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect, 
            ...
            else if(shape instanceof com.arcsoft.office.fc.hslf.model.AutoShape
                    || shape instanceof com.arcsoft.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.arcsoft.office.fc.hslf.model.Picture)
            {   
                com.arcsoft.office.fc.hslf.model.Picture poiPic = (com.arcsoft.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.arcsoft.office.fc.hslf.model.Table)
        {
            com.arcsoft.office.fc.hslf.model.Table poiTable = (com.arcsoft.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.arcsoft.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.arcsoft.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.arcsoft.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.arcsoft.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.arcsoft.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.arcsoft.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        com.arcsoft.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.arcsoft.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.arcsoft.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
