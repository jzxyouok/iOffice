...
package com.arcsoft.office.fc.doc;
...
import com.arcsoft.office.common.bookmark.Bookmark;
import com.arcsoft.office.common.borders.Border;
import com.arcsoft.office.common.borders.Borders;
import com.arcsoft.office.common.borders.Line;
import com.arcsoft.office.common.bulletnumber.ListData;
import com.arcsoft.office.common.bulletnumber.ListLevel;
import com.arcsoft.office.common.hyperlink.Hyperlink;
import com.arcsoft.office.common.picture.Picture;
...
import com.arcsoft.office.common.shape.WPAbstractShape;
import com.arcsoft.office.common.shape.WPAutoShape;
import com.arcsoft.office.common.shape.WPGroupShape;
import com.arcsoft.office.common.shape.WPPictureShape;
...
import com.arcsoft.office.fc.hwpf.HWPFDocument;
import com.arcsoft.office.fc.hwpf.model.FieldsDocumentPart;
import com.arcsoft.office.fc.hwpf.model.ListFormatOverride;
import com.arcsoft.office.fc.hwpf.model.ListTables;
import com.arcsoft.office.fc.hwpf.model.POIListData;
import com.arcsoft.office.fc.hwpf.model.POIListLevel;
import com.arcsoft.office.fc.hwpf.model.PicturesTable;
import com.arcsoft.office.fc.hwpf.usermodel.Bookmarks;
import com.arcsoft.office.fc.hwpf.usermodel.BorderCode;
import com.arcsoft.office.fc.hwpf.usermodel.CharacterRun;
import com.arcsoft.office.fc.hwpf.usermodel.Field;
import com.arcsoft.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.arcsoft.office.fc.hwpf.usermodel.HWPFShape;
import com.arcsoft.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.arcsoft.office.fc.hwpf.usermodel.HeaderStories;
import com.arcsoft.office.fc.hwpf.usermodel.InlineWordArt;
import com.arcsoft.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.arcsoft.office.fc.hwpf.usermodel.OfficeDrawing;
import com.arcsoft.office.fc.hwpf.usermodel.OfficeDrawings;
import com.arcsoft.office.fc.hwpf.usermodel.POIBookmark;
import com.arcsoft.office.fc.hwpf.usermodel.Paragraph;
import com.arcsoft.office.fc.hwpf.usermodel.PictureType;
import com.arcsoft.office.fc.hwpf.usermodel.Range;
import com.arcsoft.office.fc.hwpf.usermodel.Section;
import com.arcsoft.office.fc.hwpf.usermodel.Table;
import com.arcsoft.office.fc.hwpf.usermodel.TableCell;
import com.arcsoft.office.fc.hwpf.usermodel.TableRow;
import com.arcsoft.office.fc.util.LittleEndian;
import com.arcsoft.office.java.awt.Rectangle;
import com.arcsoft.office.java.util.Arrays;
...
import com.arcsoft.office.simpletext.model.IElement;
...
import com.arcsoft.office.simpletext.view.PageAttr;
import com.arcsoft.office.ss.util.ModelUtil;
import com.arcsoft.office.system.AbstractReader;
import com.arcsoft.office.system.IControl;
import com.arcsoft.office.wp.model.CellElement;
import com.arcsoft.office.wp.model.HFElement;
import com.arcsoft.office.wp.model.RowElement;
import com.arcsoft.office.wp.model.TableElement;
import com.arcsoft.office.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.arcsoft.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.arcsoft.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.arcsoft.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.arcsoft.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
    ...
    // 这个静态变只能com.arcsoft.office.fc.hwpf.usermodel.Pictrue 和 
    // com.arcsoft.office.fc.hwpf.usermodel.OfficeDrawingsImpl 使用，其它类不能用。
    //public static IControl controlForReader;
}
