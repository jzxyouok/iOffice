...
import com.arcsoft.office.fc.hpsf.DocumentSummaryInformation;
import com.arcsoft.office.fc.hpsf.MutablePropertySet;
import com.arcsoft.office.fc.hpsf.PropertySet;
import com.arcsoft.office.fc.hpsf.PropertySetFactory;
import com.arcsoft.office.fc.hpsf.SummaryInformation;
import com.arcsoft.office.fc.poifs.filesystem.DirectoryEntry;
import com.arcsoft.office.fc.poifs.filesystem.DirectoryNode;
import com.arcsoft.office.fc.poifs.filesystem.DocumentInputStream;
import com.arcsoft.office.fc.poifs.filesystem.Entry;
import com.arcsoft.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.arcsoft.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.arcsoft.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.arcsoft.office.fc.hpsf.WritingNotSupportedException wnse)
        {
