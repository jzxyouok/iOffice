...
public final class TitleMaster extends MasterSheet
{
     ...
     *
     */
    public TitleMaster(com.arcsoft.office.fc.hslf.record.Slide record, int sheetNo)
    {
    ...
    public MasterSheet getMasterSheet()
    {
        ...
        SlideAtom sa = ((com.arcsoft.office.fc.hslf.record.Slide)getSheetContainer()).getSlideAtom();
